...
func TestQuery(t *testing.T) {
	...
	h.GetOrCreateWithID(1, "1", lset1)
	h.GetOrCreateWithID(1, "1", lset1)
	h.GetOrCreateWithID(2, "2", lset2)
	h.GetOrCreateWithID(3, "3", lset3)
	h.GetOrCreateWithID(4, "4", lset4)
	h.GetOrCreateWithID(5, "5", lset5)
	h.GetOrCreateWithID(6, "6", lset6)
